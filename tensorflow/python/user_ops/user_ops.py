...
def SnapAlignDenseParallel(genome, options, buffer_list_pool, read, chunk_size, num_threads, subchunk_size, trace_granularity=500, name=None):
  ...
  return gen_user_ops.snap_align_dense_parallel(genome_handle=genome, options_handle=options, num_threads=num_threads,
