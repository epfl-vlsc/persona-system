...
def AGDMerge(chunk_size, buffer_list_pool, chunk_group_handles, output_buffer_queue_handle, name=None):
...
def _AGDMergeShape(op):
  ...
  chunk_handle = op.inputs[2].get_shape()
...
def AGDMergeMetadata(chunk_size, buffer_list_pool, chunk_group_handles, output_buffer_queue_handle, name=None):
  # chunk_size > 1 enforced by op registration
