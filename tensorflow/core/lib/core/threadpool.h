...
class ThreadPool {
 public:
  ...
  ThreadPool(Env* env, const string& name, int num_threads, bool pin_threads = false, int affinity_start = 0);
  ...
  ThreadPool(Env* env, const ThreadOptions& thread_options, const string& name,
             int num_threads, bool pin_threads = false, int affinity_start = 0);
