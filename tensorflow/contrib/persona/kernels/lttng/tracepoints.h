...
#define TRACEPOINT_INCLUDE "tensorflow/contrib/persona/kernels/lttng/tracepoints.h"
...
#define TRACEPOINT_DURATION_CALC(_start) (std::chrono::duration_cast<std::chrono::microseconds>(std::chrono::high_resolution_clock::now() - _start))
