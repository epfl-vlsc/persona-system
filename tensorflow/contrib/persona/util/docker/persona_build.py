...
def get_args():
    ...
    parser.add_argument("image_tag", help="the type of image to create")
    args = parser.parse_args()
    if args.file is None:
        fl = os.path.join(script_dir, "persona_{}.docker".format(args.image_tag))
...
def run(args):
    docker_name = "/".join((args.docker_org, args.image_tag))
